...
def duplicate_and_unique_movies(dataset, index_):
    ...
    print('\n')
    print('Number of duplicate movies: ', duplicate[:15])          
...
print("Details of first 5 movies:\n")
explore_data(movies,0,6)
...
for movie in movies:
     ...
     if (reviews_max[name]==no_reviews) and (name not in already):
